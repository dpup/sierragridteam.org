...
_Brief v1.4 — closed the comparison-trap loophole: a tech post may not use another technology's documented limitation to imply our approach wins in our terrain (an unverifiable coverage claim, §1/§4.1/§8/§10.4); trade-offs must name both sides' limits with equal candor and physics that actually holds. Prior: v1.3 MeshCore as platform + banned shrug closers; v1.2 perspective + identity; v1.1 voice tightening._
